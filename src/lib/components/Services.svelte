...
<MetaTags
  ...
  description="We offer bath only, bath + haircut, and add-on services. Price range from $35 to $150 depending on the weights. Add-on (à la carte) are available." />
...
<section>
  ...
  <div class="pricing">
    <div class="service-header">
      ...
      <button
        on:click={() => {
          track('book:bath-only');
          goto(
            'https://squareup.com/appointments/book/23fnx71l8w0689/LSZ72EJZNDXS8/start'
          );
        }}>Book Now</button>
    </div>
    <ul>
  ...
  <div class="package-container">
    <h2>Grooming package include</h2>
    <div>
      <ul>
        <li>
